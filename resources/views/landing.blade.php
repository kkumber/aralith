...
<body class="grid gap-20 m-auto dark:bg-dark-background">
  <header class="flex flex-col gap-4 items-center justify-center text-center">
    ...
    <button class="px-8 py-2 bg-primary-green text-white font-medium rounded-full w-max hover:bg-secondary-green hover:cursor-pointer transition-all duration-300 ease-out hover:shadow-lg">Get Started</button>
  </header>
  ...
  <footer class="border-t border-light-border dark:border-dark-border mt-20 py-8">
    <div class="container mx-auto px-4 text-center text-gray-600 dark:text-dark-text-secondary">
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button onclick="toggleDarkMode()" class="p-2 rounded-lg bg-gray-100 dark:bg-dark-surface hover:bg-gray-200 dark:hover:bg-dark-border transition-colors">
